...
parser.add_argument('--lr', type=str, default='[0.001]*300', help='learning rates for steps(list form)')
...
parser.add_argument('--max-epoch', type=int, default=200, help='maximum iteration to train (default: 100)')
